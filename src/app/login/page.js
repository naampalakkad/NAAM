...
export default function signin() {
    ...
    const handleImageChange = async (event) => {
        ...
        try {
            ...
            updatefirebaseuserdata(); // Update Firebase user data with new profile image URL
    ...
    useEffect(() => {
        if (profileImage) {
            updatefirebaseuserdata(); // Call updatefirebaseuserdata() after profileImage state is updated
        }
    }, [profileImage]);
